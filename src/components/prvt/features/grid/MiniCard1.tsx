    ...
    <div className="col-span-2 h-[375px] md:col-span-1">
      <Card>
        <div className="mx-auto w-fit">
          <CalloutChip>Feature #2</CalloutChip>
        </div>
        <p className="mb-1.5 text-center text-2xl">
          Over 50+ custom React hooks and utilities
        </p>
        <p className="mb-6 text-center text-zinc-400">
          Access more than 50 hooks and utility functions to cover you in any
          situation.
        </p>
        <BubbleButton className="mx-auto">useHook</BubbleButton>
