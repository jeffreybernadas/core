  ...
  return (
    <div className="col-span-1 h-[600px] lg:col-span-4 lg:h-[600px]">
      <Card>
        ...
        <CalloutChip>Feature #1</CalloutChip>
        <p className="mb-2 text-2xl">100+ Planned React Components</p>
        <p className="mb-8 text-zinc-400">
          Offers a wide range of components to build your web applications
          faster with theming support.
        </p>
