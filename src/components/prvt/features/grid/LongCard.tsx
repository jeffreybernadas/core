    ...
    <div className="col-span-2 h-fit sm:h-[209px]">
      <Card>
        <div className="relative z-20">
          <CalloutChip>Feature #4</CalloutChip>
          <p className="mb-1.5 text-2xl">
            Offers several React Component Libraries
          </p>
          <p className="max-w-sm text-zinc-400">
            Core components also offers several React component libraries that
            you can use right out of the box including their theming.
          </p>
        </div>
